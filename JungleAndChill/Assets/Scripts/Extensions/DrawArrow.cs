...
public static class DrawArrow {
  public static void Gizmo(Vector3 pos, Vector3 direction, float arrowHeadLength = 0.25f, float arrowHeadAngle = 20.0f) {
    ...
    var rot = direction == Vector3.zero ? Quaternion.identity : Quaternion.LookRotation(direction);
    Vector3 right = rot * Quaternion.Euler(0, 180 + arrowHeadAngle, 0) * new Vector3(0, 0, 1);
    Vector3 left = rot * Quaternion.Euler(0, 180 - arrowHeadAngle, 0) * new Vector3(0, 0, 1);
