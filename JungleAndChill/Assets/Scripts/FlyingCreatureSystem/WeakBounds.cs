...
public class WeakBounds : MonoBehaviour {
  ...
  void Start() {
    ...
    if (FindBoundsInSiblings) {
      var foundBoxes = transform.parent.GetComponentsInChildren<BoundingBox>();
      var foundSpheres = transform.parent.GetComponentsInChildren<BoundingSphere>();
